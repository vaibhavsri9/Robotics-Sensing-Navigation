...
% Load images.
buildingDir = fullfile('calib_undistort_mosaic');
...
corner = detectHarrisFeatures(grayImage);
[features, corner] = extractFeatures(grayImage, corner);
...
for n = 2:numImages
    ...
    matchedPoints = corner(indexPairs(:,1), :);
